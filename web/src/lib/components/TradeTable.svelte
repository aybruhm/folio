        ...
        <div class="w-full overflow-auto rounded-md border border-border">
            <table class="w-full text-sm">
                <thead class="border-b border-border bg-muted">
                    <tr>
                        <th
                            class="h-12 px-4 text-left align-middle font-medium text-muted-foreground w-12"
                        >
                            <input
                                type="checkbox"
                ...
                <tbody class="[&_tr:last-child]:border-0">
                    {#each trades as row (row.id)}
                        ...
                        >
                            ...
                            <td class="p-4 align-middle">
                                <Badge
                                    variant={getTradeTypeBadge(row.trade_type)}
                                >
                            ...
                            <td class="p-4 align-middle"
                                ><Amount
                                    value={formatNumber(row.quantity, 4)}
                                /></td
                            >
                            <td class="p-4 align-middle"
                                ><Amount
